...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'image' => 'صوره',
        'about' => 'النبذه',
        'advertismet_type' => 'نوع الاعلان',
        'price' => 'السعر',
        'color_id' => 'اللون',
        'shape_id' => 'الشكل',
        'fueltype_id' => 'نوع الوقود',
        'whealsystemtype' => 'نوع الدفع',
        'area_id' => 'المنطقه',
        'carenginetype_id' => 'نوع المحرك',
        'cartransmissions_id' => 'نوع ناقل الحركه',
        'door_number' => 'عدد الابواب',
        'seat_number' => 'عدد المقاعد',
        'model_id' => 'اسم الموديل',
        'status_id' => 'الحاله',
        'brand_id' => 'أسم الماركه',

              'img' => 'صوره',
        'permissions' => 'الصلاحيات',
        'emailorphone'=>'البريد الالكتروني او الهاتف ',
    ],
];
