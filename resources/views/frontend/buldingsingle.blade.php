                    ...
                    <div class="card-body p-1">
                        ...
                        <div class="desc-div py-3">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                <tr>
                                    <th scope="row">@lang('site.real estate type')</th>
                                    <td colspan="2">{{$singlea['realstattypename']}}</td>
                                    <th scope="row">@lang('site.real estate purpose')</th>
                                    <td colspan="2">{{$singlea['realstatepurpose']}}</td>
                                    <th scope="row">@lang('site.real estate period')</th>
                                    <td colspan="2">{{$singlea['realstatpreiodname']}}</td>
                                </tr>
                                <tr>
                                    <th scope="row">@lang('site.Toliet Number')</th>
                                    <td colspan="2">{{$singlea['tolietnumber']}}</td>
                                    <th scope="row">@lang('site.Room Number')</th>
                                    <td colspan="2">{{$singlea['roomnumbers']}}</td>
