    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('site.complines')</li>
            </ol>
        </section>
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.complines') <small>{{ $complines->total() }}</small></h3>

                    <form action="{{ route('dashboard.complines.index') }}" method="get">
                        ...
                        <table class="table  table-hover">
                            ...
                            @foreach ($complines as $index=>$user)
                                <tr>
                                    ...
                                    <td>{{ $user->name }}</td>
                                    <td>{{ $user->email }}</td>
                                    <td ><p style="max-width:250px;text-overflow:ellipsis; overflow:hidden;
    white-space:nowrap;" id="message">{{ $user->message }}</p></td>
                                    @if( $user->status==0)
