            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <form role="form" action="{{route('dashboard.paymentPlaces.update',$catgoiry->id)}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('put') }}
                            <div class="box-body">
                                ...
                                <div class="col-md-8 form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{$catgoiry->name}}" id="" placeholder="@lang('site.Enter brands name')">
                                </div>
