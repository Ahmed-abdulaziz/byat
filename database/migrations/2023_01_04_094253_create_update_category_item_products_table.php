...
class CreateUpdateCategoryItemProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('update_category_item_products', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('update_category_item_products');
    }
}
